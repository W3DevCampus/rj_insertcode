...
$plugin->version   = 2015060200;         	 // The current plugin version (Date: YYYYMMDDXX).
$plugin->release = '3.54.0.1159';
$plugin->requires  = 2012120300;        		// Requires this Moodle version.
$plugin->component = 'tinymce_rj_insertcode'; // Full name of the plugin (used for diagnostics).
...
if ($dbman->table_exists('config_plugins')) {
	if (!get_config('tinymce_rj_insertcode', 'uninstall')) {
		$plugin->dependencies = array (
			 'filter_wiris' => 2015060200
		);
	}
}