...
var languageClassPrefix = 'rj_insertcode_dlg';
var urlPerso = tinymce.baseURL.split('/');
urlPerso .length = urlPerso.length-2;
urlPerso=urlPerso.join('/')+'/plugins/rj_insertcode/tinymce/php';
...
var RJ_InsertCodeDialogue =
{
	...
	insert : function()
	{
		...
		var xmlhttp = new XMLHttpRequest();		
		xmlhttp.open('POST', urlPerso+'/rj_get_highlighted_code.php', false);
		xmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
		xmlhttp.send(urlParams);
